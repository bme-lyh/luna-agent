...
- Preserve the defaults `gpt-5.6-luna`, reasoning effort `max`, speed `fast`, read-only isolated workers, and four concurrent workers unless a change is explicitly requested.
