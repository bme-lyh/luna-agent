...
- Keep implicit invocation narrow: require ready independent work or a direct operational request;
  exclude trivial/sequential work, incidental model discussion, setup questions, and user opt-outs.
- Keep the injected Skill concise: at most 75 lines and 450 whitespace-delimited words. Put
